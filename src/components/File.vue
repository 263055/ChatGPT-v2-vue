<template>
  <div :class="{ activeCard: fileInfo.fileId === pcCurrent }" class="person-card">
    <div class="info">
      <div>
        <svg class="icon" height="50" p-id="4047" viewBox="0 0 1024 1024" width="50"
             x="1679461381774" xmlns="http://www.w3.org/2000/svg">
          <path
