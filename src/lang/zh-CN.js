export default {
    ...
    model: {
        ...
        n_title: "使gpt的回答能够联系上下文，但会消耗额外的token",
        n: "上下文长度（0-10）",
        stream_title: "流式输出",
        stream: "开启流式输出",
        echo_title: "回显词",
    ...
    message: {
        ...
        create_image1: "注：关于照片的问答内容并不会保存到数据库中",
        create_image2: "当刷新页面或切换对话，照片就会消失！！",
        upload_image1: "目前只支持png格式的图片O.o?",
        upload_image2: "点击右侧上传图片",
        upload_image3: "点击一个会话，在输入框内输入自己的需求，就可以编辑照片啦",
        fail_audio: "获取音频流失败啦~",
        end_recording: "结束录音咯~",
